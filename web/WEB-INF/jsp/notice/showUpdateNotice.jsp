...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="main_locbg font2"><img src="${ctx }/images/pointer.gif">&nbsp;&nbsp;&nbsp;當前位置：公告管理  &gt;  修改公告</td>
			...
			<form id="noticeForm" name="noticeForm" action="${ctx }/notice/updateNotice" method="post">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
					<tr><td class="font3 fftd">
						公告標題：<input type="text" name="title" size="30" id="title" value="${notice.title }"/>
						<span style="color: #ff0000;"></span>
					</td>
					</tr>
					<tr><td class="main_tdbor"></td></tr>

					<tr><td class="font3 fftd">公告內容：<br/>
