        ...
        $(function(){
            ...
            $("#delete").click(function(){
                ...
                if(checkedBoxs.length < 1){
                    $.ligerDialog.error("請選擇一個需要刪除的公告！");
                }else{
                    /** 得到公告選中的所有的需要刪除的ids */
                    ...
                    $.ligerDialog.confirm("確認要刪除嗎?","刪除公告",function(r){
                        if(r){
                            // alert("刪除："+ids.get());
                            // 發送請求
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;當前位置：公告管理 &gt; 公告查詢</td>
					...
					<td class="fftd">
						<form name="noticeform" method="post" id="noticeform" action="${ctx}/notice/selectNotice">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td class="font3">
										公告名稱：<input type="text" name="title">
										公告內容：<input type="text" name="content">
				...
				<c:forEach items="${requestScope.notices}" var="notice" varStatus="stat">
					<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
						...
						<td align="center"  width="40px;"><a href="#" id="prev_${notice.id }">
							<img title="預覽" src="${ctx }/images/prev.gif"/></a>
						</td>
					</tr>
				</c:forEach>
			</table>
