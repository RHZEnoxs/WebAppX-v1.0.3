        ...
        $(function(){
            ...
            $("#delete").click(function(){
                ...
                if(checkedBoxs.length < 1){
                    $.ligerDialog.error("請選擇一個需要刪除的職位！");
                }else{
                    /** 得到用戶選中的所有的需要刪除的ids */
                    ...
                    $.ligerDialog.confirm("確認要刪除嗎?","刪除職位",function(r){
                        if(r){
                            // alert("刪除："+ids.get());
                            // 發送請求
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;當前位置：職位管理 &gt; 職位查詢</td>
					...
					<td class="fftd">
						<form name="jobform" method="post" id="jobform" action="${ctx}/job/selectJob">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td class="font3">
										職位名稱：<input type="text" name="name">
