...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td class="main_locbg font2"><img src="${ctx}/images/pointer.gif">&nbsp;&nbsp;&nbsp;當前位置：員工管理  &gt; 修改員工</td>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
					<tr><td class="font3 fftd">
						<table>
							<tr>
								...
								<td class="font3 fftd">身份證號碼：<input type="text" name="cardId" id="cardId" size="20" value="${employee.cardId }"/></td>
							</tr>
							<tr>
								<td class="font3 fftd">性別：
							...
							<tr>
								<td class="font3 fftd">學歷：<input name="education" id="education" size="20" value="${employee.education }"/></td>
								<td class="font3 fftd">郵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input name="email" id="email" size="20" value="${employee.email }"/></td>
							</tr>
							<tr>
								<td class="font3 fftd">手機：<input name="phone" id="phone" size="20" value="${employee.phone }"/></td>
								<td class="font3 fftd">電&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;話：<input name="tel" id="tel" size="20" value="${employee.tel }"/></td>
							</tr>
					...
					<tr>
						<td class="font3 fftd">
							...
							QQ&nbsp;&nbsp;號碼：<input name="qqNum" id="qqNum" size="20" value="${employee.qqNum }"/>
						</td>
					</tr>
					<tr><td class="main_tdbor"></td></tr>
					...
					<tr>
						<td class="font3 fftd">
							聯繫地址：<input name="address" id="address" size="40" value="${employee.address }"/>&nbsp;&nbsp;
							郵政編碼：<input name="postCode" id="postCode" size="20" value="${employee.postCode }"/>
						</td>
					</tr>
					<tr><td class="main_tdbor"></td></tr>
					...
					<tr>
						<td class="font3 fftd">
							所學專業：<input  name="speciality" id="speciality" size="40" value="${employee.speciality }"/>&nbsp;&nbsp;
							愛&nbsp;&nbsp;&nbsp;&nbsp;好：<input name="hobby" id="hobby" size="20" value="${employee.hobby }"/>
						</td>
					</tr>
					<tr><td class="main_tdbor"></td></tr>
					...
					<tr>
						<td class="font3 fftd">
							備&nbsp;&nbsp;&nbsp;&nbsp;註：<input name="remark" id="remark" size="40" value="${employee.remark }"/>
							&nbsp;&nbsp;所屬部門：
