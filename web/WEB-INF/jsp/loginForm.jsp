...
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body style="font-family: 微軟雅黑">
<div class="page-lock">
    <div class="page-logo" style="margin-bottom: 2px">
        <a class="brand" href="login.html"
           style="font-size: 24px; color: #FFFFFF;"> WebAppX-v1.0.3
        </a>
    </div>
    <form action="login" method="post" id="loginForm"><div class="page-body">
        <img class="page-lock-img"
             src="${ctx}/js/metronic/img/profile/logo_apple.jpg" alt="">
        <div class="page-lock-info">
            <span>&nbsp;</span>
            <c:choose>
                <c:when test="${requestScope.message == null }">
                    <span style="padding-top: 5px">允許以中文名稱登錄</span>
                </c:when>
                <c:otherwise>
                ...
                <div class="controls">
                    <div class="input-icon left">
                        <i class="icon-user"></i> <input
                            class="m-wrap placeholder-no-fix" type="text" placeholder="帳號"
                ...
                <div class="controls">
                    <div class="input-icon left">
                        <i class="icon-lock"></i> <input
                            ...
                            placeholder="密碼" id="password" name="password"
                            value="${password}">
                    </div>
                </div>
            </div>
        ...
        <div class="page-footer" style="color: #fff">
            <strong>人事管理 HRM 系統</strong>:
            <br>
            【參照】 Spring + Mybatis 企業應用實戰(第二版) 第十三章 實戰項目:人事管理系統
        </div>
    </form>
</div>
